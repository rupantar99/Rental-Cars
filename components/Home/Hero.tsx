...
function Hero() {
  return (
    <div className='py-7 grid grid-cols-1 
    md:grid-cols-2'>
        <div>

        <h2 className='text-[40px] md:text-[60px] 
            font-bold '>Your <span className='text-blue-600'>Journey</span>. Your <span className='text-blue-600'>Way</span>. Shift Gears.</h2>
            <h2 className='text-[20px] text-gray-500 pr-20 mt-5'>Where Every Mile Becomes a Memory. Drive Your Dreams. Rent the Perfect Ride!
            </h2>
